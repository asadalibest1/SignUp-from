...
{/* 
    ...
    {
      data.map((item, ind)=>{
        return <a className="list-group-item list-group-item-action" data-bs-toggle="list" href={"#"+arr[ind]} role="tab">{item.name}</a>
      })
    }
        ...
        <div className="tab-content">
          ...
          return  <div className="tab-pane" id={arr[ind]} role="tabpanel" key={ind}>
