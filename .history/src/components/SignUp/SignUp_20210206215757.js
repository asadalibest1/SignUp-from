...
<div className="form-check">
    <input type="name" className="form-check-input" id="validationFormCheck2" name="name-stacked" required />
  ...
  <div className="mb-3">
    ...
    <input type="name" className="form-control is-invalid" id="validationTextarea" placeholder="Required  example textarea" required />
