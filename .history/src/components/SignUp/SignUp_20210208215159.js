  ...
  return (
    <div className="SignUp">
      ...
      <form className="was-validated">
        ...
        <div className="mb-3">
          <input type="email" className="form-control" id="validationInput" onChange={(e) => {
            setEmail(e.target.value);
              if(document.getElementsByClassName("emailerr")[0].style.visibility === "hidden"){alert("changed")}
