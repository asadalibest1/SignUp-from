...
<form className="was-validated">
  ...
  <div className="mb-3">
    <input type="name" className="form-control" id="validationInput" placeholder="Name" required />
  ...
  <div className="mb-3">
    <input type="email" className="form-control" id="validationInput" placeholder="Email" required />
    <div className="invalid-feedback">
  ...
  <div className="mb-3">
    <input type="password" className="form-control" id="validationInput" placeholder="Password" required />
    <div className="invalid-feedback">
  ...
  <div className="mb-3">
    <input type="occupation" className="form-control" id="validationInput" placeholder="Occupation" required />
    <div className="invalid-feedback">
