...
export default function SignUp() {
  ...
  const alertea = document.getElementsByClassName("alertea")[0];

  if (wakeUp == false){
    alertea.style.background = "yellow";
    // alertea.style.background = "0px";
    setWakeUp(!wakeUp)
    // alert("wakeUp1"+wakeUp);
  }else{
    document.getElementsByClassName("alertea")[0].style.background = "black";
    setWakeUp(!wakeUp)
    // alert("wakeUp2"+wakeUp);
...
<div class="alertea alert alert-warning alert-dismissible fade show py-1" role="alert">
                Please enter a valid <strong>Email </strong> addree.
